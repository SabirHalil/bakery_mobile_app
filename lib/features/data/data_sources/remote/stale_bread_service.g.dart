...
part of 'stale_bread_service.dart';
  ...
  Future<HttpResponse<List<StaleBreadAddedModel>>> getAddedStaleBreadListByDate(
    ...
    final _result = await _dio.fetch<List<dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/StaleBread/GetStaleBreadListByDate',
    ...
    var value = _result.data!
        .map((dynamic i) =>
            StaleBreadAddedModel.fromJson(i as Map<String, dynamic>))
        .toList();
  ...
  Future<HttpResponse<List<StaleBreadModel>>> getBreadProductListByDate(
    ...
    final _result = await _dio.fetch<List<dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/StaleBread/GetDoughFactoryProducts',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    var value = _result.data!
        .map((dynamic i) => StaleBreadModel.fromJson(i as Map<String, dynamic>))
        .toList();
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<dynamic>> deleteStaleBread(int id) async {
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/StaleBread/DeleteStaleBread',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<dynamic>> updateStaleBread(
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/StaleBread/UpdateStaleBread',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
